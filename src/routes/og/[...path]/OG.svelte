...
>
  <div class="flex flex-col justify-between">
    <div class="flex flex-col">
      ...
      <h2 class="mb-0 text-7 text-neutral-900/25 tracking-widest uppercase">{subtitle}</h2>
    </div>
    <a class="border-l-8 border-[#1e754fa8] pl-4 text-7 text-[#4d9375]" {href}>{href}</a>
  </div>
  <img src="https://black.readthedocs.io/en/stable/_static/logo2-readme.png" class="absolute bottom-15 w-150 -right-15" alt="black logo" />
</section>
